...
import criofrequencia2 from './img/criofrequencia2.png'

function Criofrequencia(){
    return(
        <Container fluid>
           
  <Row>
      <h1 style={{'margin-top':'120px','display': 'flex', 'align-items':'center', 'justify-content': 'center'}}>Criofrequência</h1>
    <Col>
    <img src={criofrequencia2} alt=""  style = {{ width: '80%', 'margin-top': '15px', 'display': 'block','margin-left': 'auto','margin-right': 'auto'}}/></Col>
